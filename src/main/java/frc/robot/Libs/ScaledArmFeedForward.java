 ...
 */
public class ScaledArmFeedForward {
   ...
   */
  public ScaledArmFeedForward(double ks, double kg, double kv, double ka) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
  ...
  /**
   * Creates a new ScaledArmFeedForward with the specified gains. Acceleration gain is defaulted to zero.
   ...
   * @param kv The velocity gain.
   */
  public ScaledArmFeedForward(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
   ...
   * @return The computed feedforward.
   */
  public double calculate(double positionRadians, double velocity, double scale) {
    return calculate(positionRadians, velocity, 0, scale);
  }
