...
public class TProfile {
   ...
   */
  public TProfile(Constraints constraints, State goal, State initial) {
  ...
  /**
   * Construct a TProfile.
   *
   * @param constraints The constraints on the profile, like maximum velocity.
   * @param goal The desired state when the profile is complete.
   */
  public TProfile(Constraints constraints, State goal) {
    this(constraints, goal, new State(0, 0, 0));
  }
  ...
  public State calculate(double t) {
    State result = new State(m_initial.position, m_initial.velocity, m_initial.acceleration);
